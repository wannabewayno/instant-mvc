...
function configurePackageJSON() {
    ...
    switch(framework){
        case'react':   configureReact(packageJSONPath,packageJSON);    return { framework:'react', buildPath: './client/build' };
        case'vue':     configureVue(packageJSONPath,packageJSON);      break;
        case'angular': configureAngular(packageJSONPath,packageJSON);  break;
        default:       configureDefault(packageJSONPath,packageJSON);  return { buildPath: './public' };
    }
}
